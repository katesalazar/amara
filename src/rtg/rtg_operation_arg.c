...
/*   Subsidiary block. */
	...
	*/
		...
		assertion(operation_arg->node_->sub_named_function_call_->named_function_call_->pending_semantic_checks_->called_function_has_no_return_value_ == AMARA_BOOLEAN_INVALID);  /* XXX */
		assertion(operation_type == STT_OPERATION_TYPE_EXECUTION);  /* XXX */
