 ...
 *
 * src/stt/stt_node_sub_named_function_call_arguments.h: A syntax tree
 * node can
 * represent a function call arguments list. If so, it holds some
 * information that is
 * stored in this "sub" entity.
 */

#ifndef __AMARA__SYNTAX_TREE__NODE_SUB_NAMED_FUNCTION_CALL_ARGUMENTS__H__
#define __AMARA__SYNTAX_TREE__NODE_SUB_NAMED_FUNCTION_CALL_ARGUMENTS__H__
