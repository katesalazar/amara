 ...
 *
 * src/stt/stt_rational_subnode.h: Amara syntax tree rational literal
 * subnode.
 */

#ifndef __AMARA__SYNTAX_TREE__RATIONAL_SUBNODE__H__
#define __AMARA__SYNTAX_TREE__RATIONAL_SUBNODE__H__

/*   For `amara_string`. */
#include "../cmn/amara_string.h"

typedef struct stt_rational_subnode {
	amara_string * raw_;
} stt_rational_subnode;

stt_rational_subnode *
stt_rational_subnode_default_constructor(void)
...
amara_boolean
stt_rational_subnode_equality(
		stt_rational_subnode * subnode0,
		stt_rational_subnode * subnode1)
__attribute__((warn_unused_result))
;
