...
void
stt_operations_list_subnode_constructors_tests()
{
	stt_operations_list_subnode_construct_and_destruct_test_0();
	stt_operations_list_subnode_construct_and_destruct_test_1();
}
...
tests_simple_list *
register_stt_operations_list_subnode_constructors_tests(
...
register_stt_operations_list_subnode_tests(tests_simple_list * tests)
{
	...
	returning_ = register_stt_operations_list_subnode_constructors_tests(
			tests);
	return returning_;
}
